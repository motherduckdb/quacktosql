          ...
          <div className="bg-yellow-50 p-4 rounded-md mb-4">
            <div className="flex items-start">
              ...
              <div className="text-sm text-yellow-800">
                <p className="font-medium mb-1">WebGPU Required</p>
                <p>This model requires WebGPU support. For the best experience:</p>
                <ul className="list-disc ml-4 mt-1">
                  <li>Use Chrome browser (recommended)</li>
                  <li>Enable "WebGPU" flag in chrome://flags</li>
                  <li>For Linux users: Ensure Vulkan support is installed</li>
                </ul>
              </div>
            </div>
          </div>
